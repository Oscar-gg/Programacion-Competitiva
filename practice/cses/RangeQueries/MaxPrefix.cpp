...
// Problem from: https://cses.fi/problemset/task/2166
...
// Maximum prefix sum in range[a, b]
...
void solve()
{
    ...
    while (q--)
    {
        ...
        if (a == 1)
        {
            update(1, b - 1, c, 0, n - 1, segTree);
        }
        else
        {
            cout << compute(1, b - 1, c - 1, 0, n - 1, segTree).maxPrefix << "\n";
        }
    }
}
