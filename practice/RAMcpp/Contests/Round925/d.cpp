...
// Problem from: https://codeforces.com/contest/1931/problem/D
...
void solve()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        int search = (x - rem) % x; // Mod x to consider cases where numbers intersect with x

        if (umap.count({search, rem2}))
        {
            counter += umap[{search, rem2}];
        }
